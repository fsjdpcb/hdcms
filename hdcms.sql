...
CREATE TABLE `hd_field` (
  ...
  PRIMARY KEY (`fid`),
  KEY `mid` (`mid`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='模型字段';
...
-- ----------------------------
BEGIN;
INSERT INTO `hd_flag` VALUES ('1', '热门', '1'), ('2', '置顶', '1'), ('3', '推荐', '1'), ('4', '图片', '1'), ('5', '首页幻灯片', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `hd_session` VALUES ('grgv5kh9mv8gqg7eb7ivqm71l2', 'code|s:4:\"8RTY\";uid|s:1:\"1\";admin|i:1;WEB_MASTER|b:1;username|s:5:\"admin\";realname|s:0:\"\";rid|s:1:\"1\";rname|s:15:\"超级管理员\";favicon|s:69:\"http://localhost/hdcms/./upload/favicon/2013/12/11/42661386702404.jpg\";history|s:62:\"http://localhost/hdcms/index.php?a=Field&amp;c=Field&amp;mid=1\";', '1387738924', '0.0.0.0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `hd_user` VALUES ('1', 'admin', '7fef6171469e80d32c0559f88b377245', '', '1387737692', '0.0.0.0', '', '1', '2300071698', '1', './upload/favicon/2013/12/11/42661386702404.jpg', '0', '1', '1');
COMMIT;
