    ...
    <if value="$hd.session.uid">
        <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="__WEB__?a=Home&c=Message&m=index&g=Member"> <span class="glyphicon glyphicon-envelope"></span> 我的消息</a></li>
                    <li><a href="__WEB__?a=Home&c=Favorite&m=index&g=Member"> <span class="glyphicon glyphicon-star-empty"></span> 我的收藏</a></li>
                    <li><a href="__WEB__?a=Home&c=Follow&m=fans&g=Member"> <span class="glyphicon glyphicon-heart"></span> 我的粉丝</a></li>
                    <li><a href="__WEB__?a=Home&c=Follow&m=follow&g=Member"> 我的关注</a></li>
        ...
        <li class="dropdown">
            <a href="__WEB__?a=Home&c=Message&m=index&g=Member" class="message" style="padding-left:5px !important;">
