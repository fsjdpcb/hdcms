    ...
    <if value="$hd.session.uid">
        <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="__WEB__?a=Follow&c=Follow&m=fans_list&g=Member"> <span class="glyphicon glyphicon-heart"></span> 我的粉丝</a></li>
                    <li><a href="__WEB__?a=Follow&c=Follow&m=follow_list&g=Member"> 我的关注</a></li>
