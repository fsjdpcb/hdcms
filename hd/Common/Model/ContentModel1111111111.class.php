...
class ContentModel extends RelationModel {
	...
	//自动验证
	public $validate = array( array('title', 'nonull', '标题不能为空', 1, 3), array('content', 'nonull', '内容不能为空', 1, 3));
	...
	public function __init() {
		...
		//关联栏目表
		$this -> join = array("category" => array("type" => BELONGS_TO, "foreign_key" => "cid", "parent_key" => "cid", "field" => array("cid", "catname", "mid")));
		//关联副表
		$this -> join[$this -> _stable] = array("type" => HAS_ONE, "foreign_key" => "aid", "parent_key" => "aid");
	}
