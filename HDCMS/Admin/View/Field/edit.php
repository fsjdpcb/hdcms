    ...
    <div class="wrap">
        ...
        <table class="table1">
            ...
            <tr>
				...
				<td><input type="text" name="title" class="w200" value="{$field.title}"/></td>
			</tr>
			<tr>
				<th> 字段提示 </th>
				<td><textarea name="tips" class="w400 h80">{$field.tips}</textarea></td>
			</tr>
        </table>
        <div class="field_tpl">
        ...
        <table class="table1">
			<tr>
                ...
                <td><input type="text" name="css" class="w250" value="{$field.css}"/></td>
            </tr>
			<tr>
			    <th> 字符长度取值范围 <span class="notice">系统将在表单提交时检测数据长度范围是否符合要求，如果不想限制长度请留空</span></th>
				<td> 最小值：<input type="text" name="minlength" class="w50" value="{$field.minlength}"/>
					最大值：<input type="text" name="maxlength" class="w50" value="{$field.maxlength}"/>
				</td>
			</tr>
			<tr>
				...
				<tr>
					...
					<td><input type="text" name="error" class="w300" value="{$field.error}"/></td>
                </tr>
				<tr>
				    <th> 值唯一 </th>
					<td><label>
