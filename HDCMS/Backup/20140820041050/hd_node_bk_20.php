...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('4','后台菜单管理','','Admin','Node','index','','','1','1','11','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('5','附件管理','','Admin','Attachment','index','','','1','1','7','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('6','数据备份','','Admin','Backup','backup','','','1','1','7','100','0','1')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('7','内容相关管理','','Admin','','','','','1','1','1','12','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('8','栏目管理','','Admin','Category','index','','','1','1','2','20','0','1')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('9','模型管理','','Admin','Model','index','','','1','1','7','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('10','推荐位','','Admin','Flag','index','mid=1','','1','1','37','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('11','系统设置','','Admin','','','','','1','1','3','98','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('16','网站配置','','Admin','Config','edit','','','1','1','11','90','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('22','修改个人信息','','Admin','Personal','editInfo','','','1','1','24','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('23','我的面板','','Admin','','','','','1','2','0','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('24','个人信息','','Admin','','','','','1','1','23','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('25','一键更新','','Admin','Html','createAll','','一键更新全站','1','1','17','100','0','1')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('29','审核会员','','Admin','User','index','user_status=0','','1','1','27','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('34','模板风格','','Admin','TemplateStyle','styleList','','','1','1','33','90','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('35','标签云','','Admin','Tag','index','','','1','1','37','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('37','其他操作','','Admin','','','','','1','1','1','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('38','导航菜单','','Admin','Navigation','index','','','1','1','37','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('48','数据库内容替换','','Admin','Table','contentReplace','','','1','1','7','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('50','已装插件','','Admin','','','','','1','1','39','100','0','0')");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`app`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES('51','数据备份','Addon','Backup','Admin','index','','插件Backup后台管理','1','1','50','100','0','0')");
