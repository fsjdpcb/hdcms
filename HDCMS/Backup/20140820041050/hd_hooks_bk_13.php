...
$db->exe("REPLACE INTO ".$db_prefix."hooks (`id`,`name`,`description`,`type`,`update_time`,`addons`)
						VALUES('20','conent_edit_begin','内容编辑前','1','0','Example')");
$db->exe("REPLACE INTO ".$db_prefix."hooks (`id`,`name`,`description`,`type`,`update_time`,`addons`)
						VALUES('21','content_edit_end','内容编辑后','1','0','Example')");
$db->exe("REPLACE INTO ".$db_prefix."hooks (`id`,`name`,`description`,`type`,`update_time`,`addons`)
						VALUES('22','content_del','内容删除后','1','0','Example')");
$db->exe("REPLACE INTO ".$db_prefix."hooks (`id`,`name`,`description`,`type`,`update_time`,`addons`)
						VALUES('23','content_add_begin','内容添加前','1','0','Example')");
$db->exe("REPLACE INTO ".$db_prefix."hooks (`id`,`name`,`description`,`type`,`update_time`,`addons`)
