...
<head>
    ...
    <jquery/>
    <bootstrap/>
    <link rel="stylesheet" type="text/css" href="__CONTROLLER_TPL__/css/reg.css?ver=1.0"/>
    <script>
        $(function () {
            var error = '{$error}';
            if (error) {
...
<div class="content container">
    ...
    <article class="row">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        ...
                        <img src="__CONTROLLER__&a=code" style="cursor: pointer" onclick="this.src='__CONTROLLER__&a=code&_'+Math.random()"/>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="field col-md-4">
            > 还没有账号？ <a href="__WEB__?m=Member&c=Login&a=reg">立即注册</a><br/>
            > 忘记密码？ <a href="__WEB__?m=Member&c=Password&a=findPassword">找回密码</a>
        </div>
    </article>
</div>
</body>
