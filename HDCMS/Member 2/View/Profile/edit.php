...
<head>
    ...
    <jcrop/>
    <bootstrap/>
    <link rel="stylesheet" type="text/css" href="__CONTROLLER_TPL__/css/user.css?ver=1.0"/>
    <js file="__CONTROL_TPL__/js/cropFace.js"/>
    <script type="text/javascript" src="__CONTROLLER_TPL__/uploadify/jquery.uploadify.min.js"></script>
    <link rel="stylesheet" type="text/css" href="__CONTROLLER_TPL__/uploadify/uploadify.css"/>
    <hdcms/>
</head>
<body>
