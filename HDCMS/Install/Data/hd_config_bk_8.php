...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`,`status`)
						VALUES('1','WEBNAME','HDCMS内容管理系统','site','网站名称','text','','0','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`,`status`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`,`status`)
						VALUES('7','EMAIL','2300071698@qq.com','site','管理员邮箱','text','','8','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`,`status`)
						VALUES('73','DEFAULT_GROUP','5','member','默认会员组','group','','100','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`,`status`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`,`status`)
						VALUES('67','CREATE_INDEX_HTML','1','content','首页生成静态','radio','','1','1')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`,`status`)
