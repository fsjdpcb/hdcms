...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(7,1,'EMAIL','houdunwangxj@gmail.com','管理员邮箱','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(13,2,'WATER_ON','1','图片文件加水印','radio','1|加水印,0|不加水印','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(14,1,'TEL','010-64825057','联系电话','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(15,5,'WATER_TEXT','houdunwang.com','水印文字','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(16,5,'WATER_TEXT_SIZE','16','文字大小','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(17,5,'WATER_IMG','static/image/water.png','水印图像','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(18,5,'WATER_PCT','80','水印图片透明度','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(19,5,'WATER_QUALITY','90','图片压缩比','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(20,5,'WATER_POS','9','水印位置','text','','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(21,6,'DEL_CONTENT_MODEL','0','删除文章标记为未审核','radio','1|审核,0|未审核','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(22,6,'CREATE_INDEX_HTML','1','首页生成静态','radio','1|生成,0|不生成','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(23,6,'DOWN_REMOTE_PIC','0','下载远程图片','radio','1|下载,0|不下载','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(24,6,'AUTO_DESC','1','截取内容为摘要','radio','1|是,0|否','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(25,6,'AUTO_THUMB','1','提取内容图片为缩略图','radio','1|是,0|否','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(30,7,'CACHE_INDEX','0','首页缓存时间','text','','单位秒，0为不缓存',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(31,7,'CACHE_CATEGORY','0','栏目缓存时间','text','','单位秒，0为不缓存',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(32,7,'CACHE_CONTENT','0','文章缓存时间','text','','单位秒，0为不缓存',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(40,6,'AUTO_KEYWORDS','1','自动提取内容关键字','radio','1|是,0|否','',100,1,1)");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`cgid`,`name`,`value`,`title`,`show_type`,`info`,`message`,`order_list`,`status`,`system`)
						VALUES(41,6,'AUTO_TAG','1','自动提取内容TAG','radio','1|是,0|否','',100,1,1)");
