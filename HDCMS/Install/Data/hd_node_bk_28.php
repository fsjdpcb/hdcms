...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(21,'修改密码','','Admin','Personal','editPassword','','',1,2,24,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(22,'修改个人信息','','Admin','Personal','editInfo','','',1,2,24,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(68,'水印设置','','Admin','Config','water','','',1,1,86,90,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(50,'已装插件','','Admin','','','','',1,1,39,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(117,'数据备份','Addons','Backup','Admin','index','','插件Backup后台管理',1,1,50,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(66,'友情链接','Addons','Link','Admin','index','','插件Link后台管理',1,1,50,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(67,'导航菜单','Addons','Navigation','Admin','index','','插件Navigation后台管理',1,1,50,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
...
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(112,'配置组','','Admin','ConfigGroup','index','','配置组管理',1,1,11,99,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(118,'自定义表单','Addons','CustomForm','Admin','index','','插件CustomForm后台管理',1,1,50,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(123,'广告位','Addons','Advertising','Admin','index','','插件Advertising后台管理',1,1,50,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(130,'计划任务','Addons','Crontab','Admin','index','','插件Crontab后台管理',1,1,50,100,0,0)");
$db->exe("REPLACE INTO ".$db_prefix."node (`nid`,`title`,`group`,`module`,`controller`,`action`,`param`,`comment`,`show`,`type`,`pid`,`list_order`,`is_system`,`favorite`)
						VALUES(139,'内容关键词替换','Addons','ContentKeywords','Admin','index','','插件ContentKeywords后台管理',1,1,50,100,0,0)");
