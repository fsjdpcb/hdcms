...
div#move span.left{
    background: url("__CONTROLLER_TPL__/img/ico_left.gif") no-repeat;
    left: -10px;
}
div#move span.right{
    background: url("__CONTROLLER_TPL__/img/ico_right.gif") no-repeat;
    left: 5px;
}
/*右侧内容显示区*/
div#content {
...
#tree_title span {
    display: block;
    background: url("__CONTROLLER_TPL__/ztree/css/zTreeStyle/img/diy/1_open.png");
    width: 15px;
    height: 15px;
    float: left;
    margin-right: 5px;
