                    ...
                    <list from="$data" name='field'>
                        <td class="w300">
                            <table class="table1 category" style="width:100%;">
                                ...
                                <tr>
                                    <td>
                                        <input type="text" name="cat[{$field.cid}][index_tpl]" required="" class="w250"
                                               id="index_tpl{$field.cid}" value="{$field.index_tpl}"
                                               onclick="select_template('index_tpl{$field.cid}')" readonly=""
                                               onfocus="select_template('index_tpl{$field.cid}');"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="cat[{$field.cid}][list_tpl]" required=""
                                               id="list_tpl{$field.cid}" class="w250" value="{$field.list_tpl}"
                                               onclick="select_template('list_tpl{$field.cid}')" readonly=""
                                               onfocus="select_template('list_tpl{$field.cid}');"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>内容页模板</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="cat[{$field.cid}][arc_tpl]" required=""
                                               id="arc_tpl{$field.cid}" class="w250" value="{$field.arc_tpl}"
                                               onclick="select_template('arc_tpl{$field.cid}')" readonly=""
                                               onfocus="select_template('arc_tpl{$field.cid}');"/>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="cat[{$field.cid}][cat_html_url]" required=""
                                               class="w250" value="{$field.cat_html_url}"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="cat[{$field.cid}][arc_html_url]" required=""
                                               class="w250" value="{$field.arc_html_url}"/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="cat[{$field.cid}][cat_keyworks]"
                                               value="{$field.cat_keyworks}" class="w250"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>描述</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="cat[{$field.cid}][cat_seo_title]"
                                               value="{$field.cat_seo_title}" class="w250"/>
                                    </td>
                                </tr>
                                <tr>
                                    <th>SEO描述</th>
