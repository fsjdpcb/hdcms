...
$db->exe("REPLACE INTO ".$db_prefix."flag (`fid`,`flagname`,`system`) VALUES('6','精华','1')");
$db->exe("REPLACE INTO ".$db_prefix."flag (`fid`,`flagname`,`system`) VALUES('7','置顶','1')");
$db->exe("REPLACE INTO ".$db_prefix."flag (`fid`,`flagname`,`system`) VALUES('8','站长推荐','1')");
