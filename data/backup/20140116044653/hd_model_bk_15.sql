...
$db->exe("REPLACE INTO ".$db_prefix."model (`mid`,`model_name`,`tablename`,`enable`,`description`,`app_name`,`type`,`is_submit`,`m_order`,`is_system`) VALUES('2','测试模型','test','1','','Content','1','0','0','0')");
