...
<link href="http://localhost/hdcms/hd/hdphp/Extend/Org/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen"><script src="http://localhost/hdcms/hd/hdphp/Extend/Org/bootstrap/js/bootstrap.min.js"></script>
  ...
  <![endif]--><script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Bug&c=Index&_=0.2633030978652954';
		...
		CONTROLTPL = 'http://localhost/hdcms/hd/Hdcms/Bug/Tpl/Index';
		STATIC = 'http://localhost/hdcms/hd/Hdcms/Bug/Tpl/Static';
		PUBLIC = 'http://localhost/hdcms/hd/Hdcms/Bug/Tpl/Public';
		COMMON = 'http://localhost/hdcms/Common';
</script>
    <script type="text/javascript" src="http://localhost/hdcms/hd/Hdcms/Bug/Tpl/Index/js/js.js"></script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hd/Hdcms/Bug/Tpl/Index/css/css.css"/>
</head>
<body>
<div class="wrap">
    <div class="menu_list">
