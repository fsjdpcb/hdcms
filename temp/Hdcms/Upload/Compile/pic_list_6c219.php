<?php if(!defined("HDPHP_PATH"))exit;C("SHOW_NOTICE",FALSE);?><!--站内图片-->
<div class="site_pic">
    <ul>
...
if($_index_f>=$_total_f):$hd["list"]["f"]["last"]=true;endif;?>
            ...
            <li class="upload_thumb" style="width:88px;" input_type="<?php echo $_SESSION['input_type'];?>"
                elem_id="<?php echo $_SESSION['elem_id'];?>">
