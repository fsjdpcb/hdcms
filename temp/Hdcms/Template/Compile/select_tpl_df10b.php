...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Template&m=select_tpl&input_id=list_tpl';
		...
		HISTORY = 'http://localhost/hdcms/index.php?a=Category&c=Category&m=add';
		HTTPREFERER = 'http://localhost/hdcms/index.php?a=Category&c=Category&m=add';
</script>
