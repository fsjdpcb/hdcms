...
<link rel="stylesheet" href="http://localhost/hdcms/template/guanwang/css/content.css" />
</head>
<body>
...
<div id="content"> 
  ...
  <div class="left_box">
    ...
    <div class="con_box"> <?php echo $hdcms['content'];?> 
      <!--<p class="pic">
						<a href="">
							<img src="http://localhost/hdcms/template/guanwang/images/1907734_8.jpg" alt="" />
						</a>
					</p>
					<p class="txt">
						<a href="">2013款 别克英朗XT 1.6T 时尚运动版</a>
					</p>
					<p class="con_txt">在此次新推出的2014款英朗XT上，Alcantara高级绒面内饰的搭载包括棕与黑、绒面与皮革，多元素的撞色混搭带出时尚动感，而车身颜色有有六种供消费者选择，包含冰川银/雪域白/钢琴黑/拉丁红/天际蓝/钛金灰。</p>
					<p class="pic">
						<a href="">
							<img src="http://localhost/hdcms/template/guanwang/images/1648800_8.jpg" alt="" />
						</a>
					</p>
					<p class="txt">
						<a href="">2013款 别克英朗XT 1.6T 时尚运动版</a>
					...
					<p class="pic">
						<a href="">
							<img src="http://localhost/hdcms/template/guanwang/images/1907735_8.jpg" alt="" />
						</a>
					</p>
					<p class="txt">
						<a href="">2014款英朗XT Alcantara高级绒面内饰</a>
					</p>
					<p class="con_txt">
						此外，两款1.6T车型新增了发动机远程启动功能。车主只需在手机上安装OnStar安吉星应用程序，即可轻松实现对发动机的远程遥控。
					</p>--> 
