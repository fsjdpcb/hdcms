...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Model&c=Model&m=index&_=0.031646481288287176';
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($m['is_system']==1){?>
                            ...
                            <?php  }else{ ?>
                        <a href="javascript:;"
                           onclick="return confirm('确定删除【<?php echo $m['model_name'];?>】模型吗？')?hd_ajax('<?php echo U(del);?>',{mid:<?php echo $m['mid'];?>}):false;">删除</a>
                        <?php }?>
                    </td>
                </tr>
