...
<script type='text/javascript'>
		...
		HISTORY = 'http://localhost/hdcms/index.php?g=Hdcms&a=Member&c=Member&m=index&_=0.591868028550402';
		HTTPREFERER = 'http://localhost/hdcms/index.php?g=Hdcms&a=Member&c=Member&m=index&_=0.591868028550402';
</script>
    <script type="text/javascript" src="http://localhost/hdcms/hd/Hdcms/Member/Tpl/Member/js/add_validation.js"></script>
...
<div class="wrap">
    ...
    <form action="<?php echo U('add');?>" method="post" class="form-inline hd-form">
        <table class="table1">
            <tr>
