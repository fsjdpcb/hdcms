...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Flag&c=Flag&m=index&_=0.3110171651005852';
...
if($_index_f>=$_total_f):$hd["list"]["f"]["last"]=true;endif;?>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="flag[<?php echo $f['fid'];?>][title]" value="<?php echo $f['title'];?>" class="w30"/>
                    </td>
                    <td>
