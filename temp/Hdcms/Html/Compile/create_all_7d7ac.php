...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?g=Hdcms&a=Html&c=Html&m=create_all&_=0.1467138411507496';
...
<body>
<form method="post" action="http://localhost/hdcms/index.php?a=Html&c=Html&m=create_all_html" target="_iframe" onsubmit="return $.modalShow();">
    <div class="wrap">
