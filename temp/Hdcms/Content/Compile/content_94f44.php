...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Content&c=Content&m=content&cid=2&state=1';
...
if($_index_c>=$_total_c):$hd["list"]["c"]["last"]=true;endif;?>
            ...
            <tr>
                ...
                <td align="right">
                    <a href="<?php echo U('Index/Content/content',array('cid'=>$_GET['cid'],'aid'=>$c['aid']));?>" target="_blank">访问</a><span
                        class="line">|</span>
