...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=edit&g=Plugin&id=1';
		...
		METH = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=edit';
		...
		HISTORY = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=audit&g=Plugin';
		HTTPREFERER = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=audit&g=Plugin';
</script>
...
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=add" class="action">编辑链接</a></li>
