...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Link&c=Type&m=edit&g=Plugin&tid=1';
		...
		METH = 'http://localhost/hdcms/index.php?a=Link&c=Type&m=edit';
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hd/Plugin/Link/Tpl/Type/js/edit_validate.js"></script>
</head>
<body>
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Type&m=add" class="action">修改分类</a></li>
    ...
    <form action="" method="post" class="hd-form" enctype="multipart/form-data" onsubmit="return hd_submit(this,'<?php echo U(index,array('g'=>'Plugin'));?>')">
        ...
        <table class="table1">
            <tr>
                ...
                <td>
                    <input type="text" name="type_name" value="<?php echo $field['type_name'];?>" class="w200"/>
                </td>
            </tr>
