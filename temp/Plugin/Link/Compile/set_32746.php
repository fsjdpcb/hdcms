...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Set&m=set';
		HDPHP = 'http://localhost/hdphp/hdphp';
		HDPHPDATA = 'http://localhost/hdphp/hdphp/Data';
		HDPHPTPL = 'http://localhost/hdphp/hdphp/Lib/Tpl';
		HDPHPEXTEND = 'http://localhost/hdphp/hdphp/Extend';
		APP = 'http://localhost/hdcms/index.php?a=Link';
		CONTROL = 'http://localhost/hdcms/index.php?a=Link&c=Set';
		METH = 'http://localhost/hdcms/index.php?a=Link&c=Set&m=set';
		GROUP = 'http://localhost/hdcms/hd';
		TPL = 'http://localhost/hdcms/hd/Plugin/Link/Tpl';
		CONTROLTPL = 'http://localhost/hdcms/hd/Plugin/Link/Tpl/Set';
		STATIC = 'http://localhost/hdcms/Static';
		PUBLIC = 'http://localhost/hdcms/hd/Plugin/Link/Tpl/Public';
		HISTORY = 'http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=index';
		HTTPREFERER = 'http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=index';
</script>
    <link type="text/css" rel="stylesheet" href="http://localhost/hdcms/hd/static/css/common.css"/>
    <script type="text/javascript" src="http://localhost/hdcms/hd/Plugin/Link/Tpl/Set/js/set.js"></script>
</head>
<body>
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Set&m=set" class="action">模块配置</a></li>
        </ul>
    </div>
        ...
        <table class="table1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <img src="http://localhost/hdcms/<?php echo $field['logo'];?>" alt="网站LOGO" class="h50"/>
                </td>
            </tr>
            <tr>
                <th>申请说明</th>
