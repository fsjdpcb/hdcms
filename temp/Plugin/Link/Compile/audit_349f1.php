...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=audit';
		...
		METH = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=audit';
		...
		HISTORY = 'http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=add';
		HTTPREFERER = 'http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=add';
</script>
...
<div class="wrap">
    <div class="menu_list">
        <ul>
            ...
            <li><a href="http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=audit" class="action">审核申请</a></li>
