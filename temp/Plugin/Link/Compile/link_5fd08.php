...
<head>
    ...
    <link href="http://localhost/hdcms/hd/Plugin/Link/Tpl/Index/css/style.css" rel="stylesheet" type="text/css">
    <link href="http://localhost/hdcms/hd/Plugin/Link/Tpl/Index/css/about.css" rel="stylesheet" type="text/css">
...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Link&c=Index&m=index&g=Plugin';
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hd/Plugin/Link/Tpl/Index/js/link.js"></script>
</head>
<body>
<div id="warpper">
    ...
    <div id="g-apply" class="g-apply">
        ...
        <div class="box clearfix">
            ...
            <div class="fr m-apply-form" style="height: 250px;">
                ...
                <textarea class="w350 h60" style="padding:5px;font-size:12px;" readonly=""><a href="<?php echo $hdcms['url'];?>" target="_blank"><img title="<?php echo $hdcms['webname'];?>" alt="<?php echo $hdcms['webname'];?>" src="http://localhost/hdcms/<?php echo $hdcms['logo'];?>" border="0"/></a></textarea>
                <div style="margin-top: 10px;margin-bottom: 15px;">
                示例：<a href="<?php echo $hdcms['url'];?>" target="_blank" style="margin-top: 10px;"><img title="<?php echo $hdcms['webname'];?>" align="middle" class="h30" alt="<?php echo $hdcms['webname'];?>" src="http://localhost/hdcms/<?php echo $hdcms['logo'];?>" border="0"/></a>
                </div>
