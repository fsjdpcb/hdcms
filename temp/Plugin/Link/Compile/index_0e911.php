...
<script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=index&g=Plugin';
		...
		METH = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=index';
		...
		HISTORY = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=edit&g=Plugin&id=1';
		HTTPREFERER = 'http://localhost/hdcms/index.php?a=Link&c=Manage&m=edit&g=Plugin&id=1';
</script>
...
<div class="wrap">
    <div class="menu_list">
        <ul>
            <li><a href="http://localhost/hdcms/index.php?g=Plugin&a=Link&c=Manage&m=index" class="action">友情链接</a></li>
...
if($_index_l>=$_total_l):$hd["list"]["l"]["last"]=true;endif;?>
            ...
            <tr>
                ...
                <td>
                    <img src="http://localhost/hdcms/<?php echo $l['logo'];?>" class="h30"/></td>
