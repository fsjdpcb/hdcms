...
<link href="http://localhost/hdphp/hdphp/Extend/Org/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/bootstrap/js/bootstrap.min.js"></script>
  ...
  <![endif]--><script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Template&c=Template&m=style_list';
		...
		STATIC = 'http://localhost/hdcms/hd/hdcms/Template/Tpl/Static';
    ...
    <script type="text/javascript" src="http://localhost/hdcms/hd/hdcms/Template/Tpl/Template/js/style.js"></script>
