...
<link href="http://localhost/hdphp/hdphp/Extend/Org/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/bootstrap/js/bootstrap.min.js"></script>
  ...
  <![endif]--><script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Html&c=Html&m=create_category&_=0.4937191655175571';
...
<body>
<form method="post" action="http://localhost/hdcms/index.php?a=Html&c=Html&m=make_category" class="form-inline hd-form">
    <div class="wrap">
