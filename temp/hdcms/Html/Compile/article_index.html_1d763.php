...
<div class="news_index">
    ...
    <div class="center">
        <div class="listbox">
            <div class="top">
                        <?php $mid="1";$cid =0;$listtype ="all";$flag='2';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
            ...
            <ul>
                        <?php $mid="1";$cid =0;$listtype ="all";$flag='1';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
                $cid= isset($_GET['cid'])?intval($_GET['cid']):null;
            }
    ...
    <div class="right">
        <div class="listbox">
            ...
            <div class="txt">
                <ul>
                            <?php $mid="1";$cid =0;$listtype ="all";$flag='3';$aid='';
            $_GET['mid']="1";
            if(empty($cid)){
                $cid= isset($_GET['cid'])?intval($_GET['cid']):null;
            }
            ...
            if($db->table){
                ...
                foreach($result as $field):
                    ...
                    $field['description']=mb_substr($field['description'],0,80,'utf-8');
                    ?>
                        <li><a href="<?php echo $field['url'];?>"> [<?php echo $field['time'];?>]<?php echo $field['title'];?></a></li>
                    <?php endforeach;}}?>
                </ul>
            </div>
        </div>
        ...
        <div class="left" style="width:310px;margin: 0px 5px;margin-bottom: 10px;">
            ...
            if($db->table){
                ...
                foreach($result as $field):
                    ...
                    $field['description']=mb_substr($field['description'],0,80,'utf-8');
                    ?>
                            <li><a href="<?php echo $field['url'];?>" target="_blank"> [<?php echo $field['time'];?>]<?php echo $field['title'];?></a></li>
                        <?php endforeach;}}?>
                    </ul>
                </div>
            </div>
