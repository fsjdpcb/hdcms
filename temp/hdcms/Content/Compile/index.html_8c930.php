...
<body>
	...
	<div class="sina">
		<div class="sina_box">
			<div class="qq">
				<span>HDPHP & HDCMS开发QQ群:</span>311838185
			</div>
			<a class="sina_logo">
				<img src="http://localhost/hdcms/template/bootstrap/images/Sina_Weibo_Logo_RGB_C_E.png" alt="" />
			</a>
		</div>
	</div>
	<!-- 新浪微博大盒子结束 -->
	...
	<div class="rec">
		...
		<p>我们不吹牛，不浮夸！只认真做技术，认真就够了。《这些年，我们和后盾网一起写程序》</p>
	</div>
	<!-- 开源项目推荐结束	 -->
	<!-- 内容区域开始 -->
	<div class="content">
	...
	<div class="box">
				<a href="" class="pic"><img src="http://localhost/hdcms/template/bootstrap/images/study.png" alt="" /></a>
					...
					<p>
                        在国内没有任何一个产品，即提供开源，也提供每周5免费远程培训的了。这一切你都可以在后盾网得到，而且不用支付任何费用，不只可以让你轻松使用后盾网产品，同时也可以大大提供你编程能力。
					</p>
			</div>
