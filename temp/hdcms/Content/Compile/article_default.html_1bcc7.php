    ...
    <div class="article_list">
        ...
        <div class="content">
            ...
            <div class="info">
                ...
                <small>点击:</small>
                <script language="javascript" type="text/javascript" src="http://localhost/hdcms/index.php?a=Content&c=Index&m=get_click&cid=<?php echo $hdcms['cid'];?>&aid=<?php echo $hdcms['aid'];?>"></script>次
            </div>
