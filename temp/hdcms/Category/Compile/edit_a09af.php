...
<link href="http://localhost/hdphp/hdphp/Extend/Org/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen"><script src="http://localhost/hdphp/hdphp/Extend/Org/bootstrap/js/bootstrap.min.js"></script>
  ...
  <![endif]--><script type='text/javascript'>
		...
		URL = 'http://localhost/hdcms/index.php?a=Category&c=Category&m=edit&cid=14';
		...
		STATIC = 'http://localhost/hdcms/hd/hdcms/Category/Tpl/Static';
                ...
                <div id="seo">
                    <table class="table1">
                        <tr>
                            ...
                            <td>
                                <input type="text" name="seo_title" value="<?php echo $field['seo_title'];?>" class="w350"/>
                            </td>
                        </tr>
                        <tr>
                            <td>SEO描述</td>
                            <td>
                                <textarea name="seo_description" class="w350 h150"><?php echo $field['seo_title'];?></textarea>
                            </td>
                        </tr>
                    </table>
                </div>
