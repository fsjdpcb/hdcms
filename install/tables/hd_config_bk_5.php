...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('1','WEBNAME','HDPHP社区--中国最强PHP培训机构  《后盾网》','站点配置','网站名称','文本','','100')");
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('3','HTML_PATH','html','站点配置','静态html目录','文本','','100')");
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('22','WATER_ON','0','上传配置','上传文件加水印','布尔(1/0)','','100')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('24','MEMBER_VERIFY','0','会员配置','会员注册是否需要审核','布尔(1/0)','','100')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('25','REG_SHOW_CODE','0','会员配置','会员注册是否显示验证码','布尔(1/0)','','100')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('26','REG_EMAIL','0','会员配置','注册成功是否发邮件','布尔(1/0)','','100')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('27','REG_INTERVAL','0','会员配置','2次注册间隔间间','数字','','100')");
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('23','DOWN_REMOVE_PIC_SIZE','500','上传配置','下载远程资源允许最大值','数字','','100')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('31','REPLY_CREDITS','1','会员配置','回复奖励积分','文本','会员提交回复奖励积分','100')");
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('53','CACHE_INDEX','-1','性能优化','首页缓存时间','文本','单位秒，-1为不缓存 0永久缓存','100')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('54','CACHE_CATEGORY','-1','性能优化','栏目缓存时间','文本','单位秒，-1为不缓存 0永久缓存','100')");
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('55','CACHE_CONTENT','-1','性能优化','文章缓存时间','文本','单位秒，-1为不缓存 0永久缓存','100')");
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('59','COOKIE_DOMAIN','','COOKIE配置','Cookie有效域名','文本','','100')");
...
$db->exe("REPLACE INTO ".$db_prefix."config (`id`,`name`,`value`,`type`,`title`,`show_type`,`message`,`order_list`) VALUES('62','SESSION_DOMAIN','.hdphp.com','SESSION配置','SESSION域名','文本','如.hdphp.com 设置错误将导致无法登录后台','100')");
